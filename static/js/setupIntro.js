function setupIntro() {
    ...
    var blackPiece = mainGame.display.squareElementAtPoint(new Point(1, 5));
    ...
    var queen = mainGame.display.squareElementAtPoint(new Point(5, 5));
    ...
    var whitePiece = mainGame.display.squareElementAtPoint(new Point(7, 5));
